    ...
    <main className="min-h-screen">
      ...
      <section className="pt-32 pb-20 bg-gradient-to-br from-slate-50 via-blue-50/30 to-white relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            {t('about.hero.title')} <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">3S</span>
          </motion.h1>
          <motion.p
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section id="about-3s" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl font-bold text-brand-slate mb-6">
              ...
              <div className="space-y-4">
                <div className="flex items-start space-x-3">
                  ...
                  <p className="text-brand-muted">{t('about.section.bullet1')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-brand-blue mt-1 flex-shrink-0" />
                  <p className="text-brand-muted">{t('about.section.bullet2')}</p>
                </div>
                <div className="flex items-start space-x-3">
                  <CheckCircle className="w-6 h-6 text-brand-blue mt-1 flex-shrink-0" />
                  <p className="text-brand-muted">{t('about.section.bullet3')}</p>
                </div>
              </div>
            </motion.div>
            <motion.div
              ...
              className="relative"
            >
              <div className="bg-gradient-to-br from-blue-600 to-blue-400 rounded-2xl p-8 shadow-xl" style={{color: 'white'}}>
      ...
      {/* Core Values Section */}
      <section id="values" className="py-24 bg-gradient-to-b from-white via-gray-50/50 to-white relative overflow-hidden">
        {/* Background decoration */}
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {coreValues.map((value, index) => (
              <motion.div
                ...
                className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:border-blue-200 transform hover:-translate-y-2"
              >
                ...
                <h3 className="text-xl font-bold text-gray-800 mb-3 text-center group-hover:text-blue-600 transition-colors">{value.title}</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {gains.map((gain, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ duration: 0.6, delay: index * 0.1 }}
                className="group flex items-start space-x-3 p-6 bg-white rounded-2xl border border-gray-100 shadow-md hover:shadow-xl hover:border-blue-200 hover:-translate-y-1 transition-all duration-300"
              >
        ...
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            <div className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-6">
              ...
              <span className="text-sm font-semibold text-blue-100">{t('about.companyProfile.badge')}</span>
            </div>
          ...
          >
            {/* Glow effect */}
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-purple-600 to-indigo-600 rounded-3xl blur-2xl opacity-30 group-hover:opacity-50 transition-opacity duration-500"></div>
              ...
              <div className="flex flex-col lg:flex-row items-center gap-10">
                ...
                >
                  <div className="relative inline-block mb-6">
                    ...
                    <div className="relative w-32 h-32 bg-gradient-to-br from-blue-600 to-indigo-600 rounded-3xl flex items-center justify-center shadow-2xl transform group-hover:scale-110 group-hover:rotate-3 transition-all duration-300">
                ...
                <div className="flex-1 text-center lg:text-left">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
                    <a
                      ...
                      className="group/btn relative inline-flex items-center justify-center gap-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-8 py-4 rounded-xl font-bold shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 overflow-hidden"
                    >
                      <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-purple-600 opacity-0 group-hover/btn:opacity-100 transition-opacity duration-300"></div>
                    ...
                    <a
                      ...
                      type="application/pdf"
                      className="group/btn inline-flex items-center justify-center gap-3 bg-white border-2 border-gray-200 text-gray-700 px-8 py-4 rounded-xl font-bold hover:border-blue-600 hover:text-blue-600 hover:bg-blue-50 hover:shadow-lg transition-all duration-300"
                    >
          ...
          >
            ...
            <Link href={`/${locale}/contact`}>
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="group bg-white text-blue-600 px-10 py-5 rounded-2xl font-bold text-lg shadow-2xl hover:shadow-3xl transition-all duration-300 inline-flex items-center gap-3"
              >
                {t('about.cta.button')}
